...
<div class="page-header my-auto pt-3 d-none d-lg-flex">
    ...
    <ul class="breadcrumbs mb-3">
        ...
        <li class="nav-item">
            <a href="/laporan-jenis-cucian">Laporan Jenis Cucian</a>
        </li>
    </ul>
</div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-8 col-stats d-flex flex-column justify-content-start align-items-start ">
                    <div class="numbers">
                        <p class="card-category">Total Jenis Cucian Saat Ini</p>
                        <h4 class="card-title"><?php echo $data ?></h4>
                    </div>
                    <form action="/cetak-laporan-jenis-cucian" method="post" target="_blank">
                        <label for="jenisCucian">Cetak Jumlah Jenis Cucian</label>
                        <input type="number" name="jenisCucian" id="jenisCucian" max="<?php echo $data ?>" required
